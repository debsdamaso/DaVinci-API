...
namespace MLModel_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\milka\Documents\SPRINT4_NET\DaVinci-API\API\MLModels\Data\sentimento_produtos_normalizado.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Sentimento",inputColumnName:@"Sentimento",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Sentimento", sentence1ColumnName: @"Comentario"))      
