...
namespace MLModel_ConsoleApp1
{
    public partial class MLModel
    {
        ...
        public class ModelInput
        {
            ...
            [LoadColumn(1)]
            [ColumnName(@"Sentimento")]
            public float Sentimento { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Sentimento")]
            public uint Sentimento { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Sentimento");
            if (labelColumn == null)
            {
                throw new Exception("Sentimento column not found. Make sure the name searched for matches the name in the schema.");
            }
